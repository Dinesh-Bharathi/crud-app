...
picture.onchange = function(){
  ...
  let file = fileInput.files[id];
  
  let formData = new FormData();
  formData.append("file", file[id]);
  
  let img = document.createElement("img");
  // To display the image, you can create an <img> element and set its src attribute to the URL of the uploaded image
...
function resetForm() {
    ...
    document.getElementById("img-con").innerHTML =`<img src = "images/profile.png">`;
